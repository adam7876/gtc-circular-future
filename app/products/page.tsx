...
export default function ProductsPage() {
  return <main className="catalog-page">
    <header className="nav-wrap dark-nav"><Link className="brand" href="/"><span className="brand-mark">G</span><span>GTC</span><small>GLOBAL HOLDING</small></Link><nav><Link href="/governance">垃圾治理</Link><Link href="/#technology">核心技術</Link><Link href="/#cycle">循環產業</Link><Link href="/products">司木商品</Link><Link href="/#about">關於集團</Link></nav><Link className="nav-cta" href="/governance#cooperation">洽詢合作 <span>↗</span></Link></header>
