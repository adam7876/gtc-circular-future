...
{ slug:"smoof-basic", name:"源司木", english:"SMOOF BASIC", category:"司木建材", short:"WPC 木塑複合基礎系列，提供板材、角材與多種表面規格。", description:"以 WPC 木塑複合材料發展的基礎系列，從平板、企口板到結構角材皆有對應規格；可依應用選擇色澤與表面，適合作為戶外地板、圍籬與景觀構件的材料基礎。", image:"/catalog/smoof-basic.jpg", material:"WPC 木塑複合材料", features:["多種斷面與尺寸","戶外耐候應用","色澤與表面可選","可依工程需求加工"], use:"景觀地板、圍籬、欄杆、戶外構件" },
  { slug:"smoof-raise", name:"精司木", english:"SMOOF RAISE", category:"司木建材", short:"PVC 系列板材與線材，對應裝潢、櫃體及空間收邊。", description:"以 PVC 為材料基礎的板材與線材系列，型錄列有多款踢腳、收邊、板件與異形斷面，能延伸至室內裝潢、櫃體與機能空間。", image:"/catalog/smoof-raise.jpg", material:"PVC 複合材料", features:["板材與異形材完整","色彩選擇多元","容易清潔維護","適合空間系統整合"], use:"室內裝潢、櫃體、踢腳板、收邊系統" },
