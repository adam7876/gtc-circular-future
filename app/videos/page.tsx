...
export const metadata: Metadata = createPageMetadata({title:"影片紀錄｜GTC",description:"從掩埋場治理、司木加工到棧板應用，觀看 GTC 提供的材料與製造現場原始影片。",path:"/videos",alternatePath:"/en/videos"});
export default function VideosPage(){
 ...
 <video controls playsInline preload="none" poster={v.slug === "landfill-recovery" ? undefined : `/videos/${v.slug}.jpg`} aria-label={v.title} aria-describedby={`${v.slug}-description`}><source src={`/videos/${v.slug}.mp4`} type="video/mp4"/>您的瀏覽器不支援播放，請<a href={`/videos/${v.slug}.mp4`}>開啟影片</a>觀看。</video>
